                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <div class="ltn__video-img ltn__video-img-before-none ltn__animation-pulse2">
                            <img src="asstes/img/others/18.png" alt="video popup bg image">
                    ...
                    <div class="about-us-info-wrap">
                        ...
                        <div class="about-author-info d-flex mt-50">
                            ...
                            <div class="author-sign  align-self-center">
                                <img src="asstes/img/icons/icon-img/author-sign.png" alt="#">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="ltn__call-to-action-area ltn__call-to-action-4 bg-image" data-bg="asstes/img/bg/36.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ltn__call-to-4-img-2">
                        <img src="asstes/img/bg/35.png" alt="#">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ltn__video-popup-area ltn__video-popup-margin---">
        <div class="ltn__video-bg-img ltn__video-popup-height-600--- bg-overlay-black-30 bg-image bg-fixed ltn__animation-pulse1" data-bg="asstes/img/bg/37.jpg">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3 ltn__team-item-3-2">
                        <div class="team-img">
                            <img src="asstes/img/team/IMG 1.webp" alt="Image">
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3 ltn__team-item-3-2">
                        <div class="team-img">
                            <img src="asstes/img/team/IMG 2.jpg" alt="Image">
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3 ltn__team-item-3-2">
                        <div class="team-img">
                            <img src="asstes/img/team/IMG 3.jpg" alt="Image">
                        </div>
                        <div class="team-info">
    ...
    <div class="ltn__call-to-action-area call-to-action-6 before-bg-bottom---" data-bg="asstes/img/1.jpg--">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="ltn__testimoni-author-ratting">
                                <div class="ltn__testimoni-info-inner">
                                    <div class="ltn__testimoni-img">
                                        <img src="asstes/img/testimonial/1.jpg" alt="#">
                                    </div>
                    ...
                    <div class="ltn__testimonial-item ltn__testimonial-item-7 ltn__testimonial-item-8">
                        <div class="ltn__testimoni-info">
                            <div class="ltn__testimoni-author-ratting">
                                <div class="ltn__testimoni-info-inner">
                                    <div class="ltn__testimoni-img">
                                        <img src="asstes/img/testimonial/2.jpg" alt="#">
                                    </div>
                                    <div class="ltn__testimoni-name-designation">
                                        <h5>Jacob William</h5>
                                        <label>Selling Agents</label>
                    ...
                    <div class="ltn__testimonial-item ltn__testimonial-item-7 ltn__testimonial-item-8">
                        <div class="ltn__testimoni-info">
                            <div class="ltn__testimoni-author-ratting">
                                <div class="ltn__testimoni-info-inner">
                                    <div class="ltn__testimoni-img">
                                        <img src="asstes/img/testimonial/3.jpg" alt="#">
                                    </div>
                                    <div class="ltn__testimoni-name-designation">
                                        <h5>Jacob William</h5>
                                        <label>Selling Agents</label>
                    ...
                    <div class="ltn__testimonial-item ltn__testimonial-item-7 ltn__testimonial-item-8">
                        <div class="ltn__testimoni-info">
                            <div class="ltn__testimoni-author-ratting">
                                <div class="ltn__testimoni-info-inner">
                                    <div class="ltn__testimoni-img">
                                        <img src="asstes/img/testimonial/4.jpg" alt="#">
                                    </div>
                                    <div class="ltn__testimoni-name-designation">
                                        <h5>Jacob William</h5>
                                        <label>Selling Agents</label>
