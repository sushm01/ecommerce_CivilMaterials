...
<div class="content-wrapper">
 ...
 <!-- fisrt content -->
    ...
    <div class="container-fluid">
      ...
      <div class="row">
           <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <a class="btn btn-app bg-blue" href="<?php echo base_url('user-order-list'); ?>">  
  ...
  <!-- third Content Header (Page header) -->
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
     ...
     <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <a class="btn btn-app bg-success" href="<?php echo base_url('admin-vendor-approval'); ?>">  
                <?php if ($totalVendor > 0): ?>
                <span class="badge bg-yellow blink"><?php echo $totalVendor; ?></span>
                <?php endif; ?><i class="fas fa-users"></i></a>
              <div class="info-box-content">
                <span class="info-box-text">New Vendors</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <a class="info-box-icon bg-danger elevation-1" href="<?php echo base_url('admin-vendor-list'); ?>" ><i class="fas fa-calculator"></i></a>
              <div class="info-box-content">
