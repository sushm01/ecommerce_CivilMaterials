                ...
                <div class="row">
                    ...
                    <!-- <div class="table-card"> -->
                        ...
                        <div class="card card-gray">
                            ...
                            <!-- form start -->
                            <form method="post" action="<?php echo base_url('welcome/insertCategory')?>">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Category Name</label>
                                        <input type="text" name="category_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Category Name" autocomplete="off">
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
     ...
     <form method="post" action="<?=base_url('welcome/updateCategory')?>">
        <div class="modal-body">
                   <div class="row">
                   <div class="col-sm-6">
                    <div class="form-group inline-block">
                    <label class="inline-block">Category Name</label>
                    <input type="hidden" name="id" id="id"> 
                    <input type="text" name="category_name" id="categoryRole" class="form-control inline-block brand_name" placeholder="Enter Category"/>
...
<script>
    ...
    function setDataFunction(id, categoryRole){
       // alert(id)
      $('#id').val(id); 
      $('#categoryRole').val(categoryRole); 
