...
//         console.log('Number of confirm buttons:', document.querySelectorAll('.confirm-btn').length);

//         button.addEventListener('click', function() {
//             alert('Button clicked!'); // Alert to confirm click
//             const cartDetailId = this.getAttribute('data-id');
//             console.log('Cart Detail ID:', cartDetailId);
//             sendMessage(cartDetailId);
//         });
//     });
// });


// function sendMessage(cartDetailId) {
//     console.log('Sending cartDetailId:', cartDetailId);
//     if (cartDetailId) {
//         $.ajax({
//             url: 'welcome/updateCartDetailStatus',
//             type: 'POST',
//             data: { id: cartDetailId },
...
//         });
//     } else {
//         alert('Cart Detail ID is missing.');
//     }
// }
 ...
 function handleConfirmClick(orderId) {
    console.log("Button clicked for Order ID:", orderId);
    
    if (orderId) {  // Use orderId instead of cartDetailId
        $.ajax({
            url: 'welcome/updateCartDetailStatus', // Make sure this URL is correct
            type: 'POST',
            data: { id: orderId }, // Use orderId here
            success: function(response) {
                alert(response.message);  // Display success message
            },
            error: function(xhr, status, error) {
        ...
        alert('Order ID is missing.'); // Update message accordingly
    }
}
