...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light fixed-top">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="paint">Vendor</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('dashboard-page')?>" class="nav-link">Dashboard</a>
      </li>
       <li class="nav-item dropdown">
            ...
            <li><a href="<?php echo base_url('vendor-add-product')?>" class="dropdown-item">Add Product</a></li>
            <li><a href="<?php echo base_url('vendor-view-product')?>" class="dropdown-item">View Product</a></li>
            </ul>
        </li>
       <!-- <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo base_url('vendor-order-history')?>" class="nav-link">Order History</a>
        </li>
    </ul>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="<?php echo base_url('vendor-logout'); ?>">Logout</a>
        </div>
    </li>
</ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<?php echo base_url('dashboard_page')?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('vendor-add-product')?>" class="nav-link">
